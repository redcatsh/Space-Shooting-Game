...
let gameOver = false //true 이면 게임이 끝남, false이면 게임끝남
let score = 0;
...
function loadImage() {
    ...
    bulletImage.src = "img/bullet2.png";
...
function update() {
    ...
    //우주선의 좌표값이 무한대로 업데이트가 되는게 아닌! 캔버스 안에서만 있게 하려면?
...
function render() {
    ctx.drawImage(backgroundImage, 0, 0, canvas.width, canvas.height); //x,y 좌표, 이미지 가로, 높이
